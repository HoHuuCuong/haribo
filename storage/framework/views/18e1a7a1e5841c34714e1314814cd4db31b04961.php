        ...
        <section class="card">
            <header class="card-header">
                <div class="card-actions">
                    <a href="<?php echo e(route('b.account.add')); ?>" class="card-action text-success" ><i class="fa fa-plus"></i> Add new</a>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/myho/Sites/Sources/harico/resources/views/backend/accounts/list.blade.php ENDPATH**/ ?>