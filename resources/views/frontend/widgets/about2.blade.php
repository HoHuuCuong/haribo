	...
	<div class="row mb-5">
        ...
        <div class="row">
            <div class="col-md-4 d-flex align-items-center bg-xanh p-0">
                <img src="{{imgApp($config['ABOUTIMG1']->value,[],0,0,true)}}" alt="Image" class="img-fluid mx-auto">
            </div>
			...
			<div class="col-md-4 d-flex align-items-center bg-xanh2 p-0" >
                <img src="{{imgApp($config['ABOUTIMG2']->value,[],0,0,true)}}" alt="Image" class="img-fluid mx-auto">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 bg-dat p-0 d-flex align-items-center">
            ...
            <div class="col-md-4 d-flex align-items-center bg-xanh2 p-0" >
                <img src="{{imgApp($config['ABOUTIMG3']->value,[],0,0,true)}}" alt="Image" class="img-fluid mx-auto">
            </div>
			<div class="col-md-4 d-flex align-items-center bg-dat p-0" >
                <img src="{{imgApp($config['ABOUTIMG4']->value,[],0,0,true)}}" alt="Image" class="img-fluid mx-auto">
            </div>
        </div>
    </div>
</div>
