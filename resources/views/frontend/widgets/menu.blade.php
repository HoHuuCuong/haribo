          ...
          <nav class="site-navigation position-relative text-right" role="navigation">
            ...
            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              <li><a href="{{route('f.home')}}" class="nav-link">{{__('Home')}}</a></li>
                <li><a href="{{route('f.registration')}}" class="nav-link">{{__('Registration')}}</a></li>
              <li>
                <a href="{{route('f.program')}}" class="nav-link">{{__('Program rules')}}</a>
              </li>
              <li>
                <a href="{{route('f.products')}}" class="nav-link">{{__('Products')}}</a>
              </li>
              <li>
                <a href="{{route('f.about')}}" class="nav-link">{{__('About Us')}}</a>
              </li>
              <li>
                <a href="{{route('f.contact')}}" class="nav-link">{{__('Contact')}}</a>
              </li>
            </ul>
          </nav>
        </div>
