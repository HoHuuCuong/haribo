    ...
    <div class="col">
        <section class="card">
            ...
            <div class="card-body">
                ...
                'image' => __('Image'),
                'name' => __('Name'),
                'categoryName' => __('Category'),
                'storename' => __('Store'),
                // 'price'=>__('Price').'<button data-sync="'.route('b.product.sync').'" title="Sync price"
                //     data-getdata="'.route('b.product.getsync').'" class="btn btn-sm btn-outline-danger btn-syncprice"><i
                ...
                'func'=>'number_format',
                'params'=>[],
                'content'=>'<span id="price-|id|">|price|</span>'
                ],
                'status'=>[
                'type'=>'switch',
                'case'=>[
