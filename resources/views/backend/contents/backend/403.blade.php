        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="main-error mb-3">
                    <h2 class="error-code text-dark text-center font-weight-semibold m-0">403 <i class="fas fa-low-vision"></i></h2>
                    <p class="error-explanation text-center">{{__('backend.deny.content')}}</p>
                </div>
            </div>
            <div class="col-lg-4">
                <h4 class="text">{{__('backend.deny.suggest')}}</h4>
