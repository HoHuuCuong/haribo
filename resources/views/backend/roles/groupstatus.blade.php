    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title">{!! __('Select status for :name', ['name' => $group->name])!!}</h2>
                    ...
                    <ul>
                        <li class="folder" data-jstree='{ "opened" : true }'>
                            ...
                            <ul>
                                ...
                                @php $checked =  \App\Model\AccessStatus::checked($item->id, 0, $group->id) ? ' ,"selected" : true' : ''; @endphp
            ...
            <div class="card-footer">
                ...
                <button class="btn btn-sm btn-primary setrolegroup" data-href="{{route('b.role.setgroupstatus',$group->id)}}"><i class="fas fa-save"></i> {{__('backend.button.save')}}</button>
            </div>
        </section>
    </div>
</div>
