        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                ...
                <ul class="nav nav-main">
                    {!! $menus !!}
                    @if (Auth::guard('backend')->user()->username == 'admin')
                    <li class="nav-parent nav-link" id="addfuncs" style="cursor: pointer"
                        data-api1="{{route('b.system.getfuncs')}}" data-api2="{{route('b.system.createfunc')}}"
                        data-api3="{{route('b.system.getroutes')}}"> <i class="fas fa-plus" aria-hidden="true"></i>
                        <span>Thêm mới chức năng</span>
                    </li>
                    <li class="nav-parent nav-link" id="editfunc" style="cursor: pointer"
                        data-api1="{{route('b.system.getfuncs')}}" data-api2="{{route('b.system.getfunc')}}"
                        data-api3="{{route('b.system.updatefunc')}}" data-api4="{{route('b.system.getroutes')}}"> <i
